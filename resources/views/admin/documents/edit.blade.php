                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('e.documents.update', $doc->id) }}" method="POST" id="docForm">
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <input type="text" name="client_name"
                                       value="{{ old('client_name', $doc->client_name) }}"
                                       list="clientsList"
                        ...
                        <div class="text-right">
                            <a href="{{ route('e.documents.view', $doc->id) }}" target="_blank" class="btn btn-outline-success mr-2">
                                <i class="fe fe-printer fe-16 mr-1"></i> Preview
                            </a>
