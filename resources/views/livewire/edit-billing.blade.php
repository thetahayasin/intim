            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <strong class="card-title mb-0"><i class="fe fe-edit fe-16 mr-1"></i> Edit Billing #{{ $billingId }}</strong>
                        <span class="badge badge-warning">{{ count($items) }} Item(s)</span>
                    </div>
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="save">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group mb-3">
                                    ...
                                    <input type="hidden" id="edit_client_id_hidden" wire:model.live="client_id">
                                    <div wire:ignore>
                                        <select class="form-control" id="edit_client_id" style="width:100%">
                                ...
                                <div class="col-md-3 form-group mb-3">
                                    ...
                                    <input type="hidden" id="edit_firm_hidden" wire:model.live="firm">
                                    <div wire:ignore>
                                        <select class="form-control" id="edit_firm" style="width:100%">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    <label><strong>Total Discount (Rs.)</strong></label>
                                    <input type="number" step="0.01" wire:model.live.debounce.300ms="discount" class="form-control" placeholder="0">
                            ...
                            @foreach($items as $index => $item)
                                <div class="card mb-3" wire:key="eitem-{{ $index }}" style="border:1px solid rgba(0,0,0,0.1);border-radius:8px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" step="0.01" wire:model.live.debounce.500ms="items.{{ $index }}.amount" class="form-control" placeholder="0">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group mb-2">
                            ...
                            <div class="row align-items-center p-3 rounded" style="background:linear-gradient(135deg,#f8f9fa,#e9ecef);border:1px solid #dee2e6;">
                                <div class="col-md-8 d-flex flex-wrap align-items-center">
                                    <div class="mr-4 mb-2"><strong>Subtotal:</strong> <span class="ml-1">Rs. {{ number_format($subtotal, 2) }}</span></div>
                                    <div class="mr-4 mb-2"><strong>Tax:</strong> <span class="ml-1">Rs. {{ number_format($totalTax, 2) }}</span></div>
                                    @if($discount > 0)
                                ...
                                <div class="col-md-4 text-right">
                                    <button type="submit" class="btn btn-warning btn-lg w-100" wire:loading.attr="disabled">
                                        <span wire:loading.remove><i class="fe fe-save fe-16 mr-1"></i> Update Billing</span>
                                        <span wire:loading><span class="spinner-border spinner-border-sm mr-1"></span> Saving...</span>
                                    </button>
                                </div>
                            </div>
                        </form>
